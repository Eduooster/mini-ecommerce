package com.example.miniecommerce.service.ProdutoServices;

import com.example.miniecommerce.domain.Produto;
import com.example.miniecommerce.infra.exception.ProdutoJaCadastrado;
import com.example.miniecommerce.infra.exception.ProdutoNaoExiste;
...
public class CrudProdutoService {
    ...
    public ProdutoDetailsResponseDto cadastrar(ProdutoCreateRequestDto dto) {
    ...
    public ProdutoDetailsResponseDto deletar(Long id) {
        ...
        Produto produto = produtoRepository.findById(id)
                .orElseThrow(()-> new ProdutoNaoExiste("Produto não encontrado!"));
